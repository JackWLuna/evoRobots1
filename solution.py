...
class SOLUTION:
    ...
    def Generate_Brain(self):
        ...
        pyrosim.Send_Sensor_Neuron(name = 14 , linkName = "Head")
        ...
        pyrosim.Send_Motor_Neuron( name = 15 , jointName = "Torso_LeftHip")
        pyrosim.Send_Motor_Neuron( name = 16 , jointName = "Torso_RightHip")
        pyrosim.Send_Motor_Neuron( name = 17 , jointName = "LeftHip_LeftThigh")
        pyrosim.Send_Motor_Neuron( name = 18 , jointName = "RightHip_RightThigh")
        pyrosim.Send_Motor_Neuron( name = 19 , jointName = "LeftThigh_LeftCalf")
        pyrosim.Send_Motor_Neuron( name = 20 , jointName = "RightThigh_RightCalf")
        pyrosim.Send_Motor_Neuron( name = 21 , jointName = "Torso_LeftShoulder")
        pyrosim.Send_Motor_Neuron( name = 22 , jointName = "Torso_RightShoulder")
        pyrosim.Send_Motor_Neuron( name = 23 , jointName = "LeftShoulder_LeftBicep")
        pyrosim.Send_Motor_Neuron( name = 24 , jointName = "RightShoulder_RightBicep")
        pyrosim.Send_Motor_Neuron( name = 25 , jointName = "LeftBicep_LeftForearm")
        pyrosim.Send_Motor_Neuron( name = 26 , jointName = "RightBicep_RightForearm")
        pyrosim.Send_Motor_Neuron( name = 27 , jointName = "Torso_Head")
